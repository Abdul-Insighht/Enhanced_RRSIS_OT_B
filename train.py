...
def get_scheduler(optimizer, args, steps_per_epoch):
    """Create learning rate scheduler with warmup and a 15% minimum learning rate floor."""
    ...
    def lr_lambda(current_step):
        ...
        # Introduce a 15% minimum floor (eta_min = 0.15) so learning rate never decays to zero
        eta_min = 0.15
...
def main():
    ...
    if args.resume and os.path.isfile(args.resume):
        ...
        print(f"  Resumed at epoch {start_epoch}, best_iou={best_iou:.4f}, patience={patience_counter}")
