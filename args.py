...
def get_parser():
    ...
    parser.add_argument('--use_dense_mask_prompt', action='store_true', default=True,
                        help='Enable Dense Mask Prompt from OT')
    parser.add_argument('--use_native_decoder', action='store_true', default=True,
                        help='Enable SAM3 Native Mask Decoder (replaces DETR)')
    ...
    parser.add_argument('--tbl_weight', type=float, default=0.5,
